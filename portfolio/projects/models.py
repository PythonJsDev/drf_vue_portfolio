...
class Project(models.Model):
    ...
    slug = models.SlugField(blank=True)
    items_list = models.CharField(max_length=2000, blank=True)
    ...
    related_project_name = models.CharField(max_length=128, blank=True)
    related_project_url = models.URLField(max_length=200, blank=True, null=True)
